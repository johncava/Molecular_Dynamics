...
# Usage:
##############################################################
# Notes: cGAN_D_pos-2.2.0 adds noise rate in which we take the
# labels for the generator and discriminator during discriminator
# training step, and  with a specific noise, flip the labels
# (i.e ones are turned to zero, and zero turned to ones)
##############################################################
'''
###
# Import
...
def update_D(data, discriminator, decoder, noise_rate=0.20):
    '''
