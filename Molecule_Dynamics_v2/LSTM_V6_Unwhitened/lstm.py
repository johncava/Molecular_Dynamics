...
files = glob.glob('/home/jcava/10_deca_alanine_main_dataset/10_deca_alanine/*/backbone.npy')
...
for epoch in range(max_epochs):
    ...
    for data in training_dataset:
        ...
        pred_matrix = dist_matrix(output,output)*z
        y_matrix = dist_matrix(y,y)*z
        loss = position_loss + F.mse_loss(output, y) + F.mse_loss(output_phi,y_phi) + F.mse_loss(output_psi,y_phi) + F.mse_loss(pred_matrix,y_matrix)
