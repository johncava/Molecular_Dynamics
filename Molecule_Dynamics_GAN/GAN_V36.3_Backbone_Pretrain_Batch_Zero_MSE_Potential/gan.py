...
min_val = 1e9
for q, learning_rate in enumerate([1e-2, 1e-2, 1e-2, 1e-2, 1e-3, 1e-3, 1e-3, 1e-3, 1e-3]):
    ...
    for epoch in range(max_epochs):
        ...
        for i, data in enumerate(pretrain_dataloader):
            ...
            for px, t_phi, t_bonds, t_angles, t_dihedrals, pt in zip(pred_x,target_phi,target_bonds,target_angles,target_dihedrals, t):
            ...
            total_potential = total_bonds/batch_size + total_angles/batch_size + total_dihedrals/batch_size
