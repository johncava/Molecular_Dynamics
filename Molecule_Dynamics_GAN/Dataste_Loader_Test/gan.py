...
class PotentialEnergyDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sample = {'frame': frame, 'potential': potential[0]['bonds'], 'phi': phi}
...
pretrain_dataset = PotentialEnergyDataset(pretrain_dataset)

pretrain_dataloader = torch.utils.data.DataLoader(pretrain_dataset, batch_size=4,
