##
# GAN_V10: Added target end to end distance of atom 1 and atom 10, averaged for each frame from the 200 trajectory dataset
...
potential_factors =  [(0.1,0.1,0.1,0.1) for _ in range(max_epochs-1)] + [(1.0,1.0,1.0,1.0)]
end2end_factors = [200.0, 100.0, 10.0]
...
for epoch in range(max_epochs):
    ...
    for data in training_dataset:
        ...
        end2end_factor = torch.tensor(end2end_factors[epoch]).float().cuda()
