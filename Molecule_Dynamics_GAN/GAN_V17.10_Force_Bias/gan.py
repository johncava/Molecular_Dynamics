...
potential_factors = [(0.1,0.1,0.1,0.1) for _ in range(max_epochs)]
...
for epoch in range(max_epochs):
    ...
    for data in training_dataset:
        ...
        end2end_factor = torch.tensor(500.0).float().cuda()
        ...
        for i in range(2):
            ...
            # Update generator weights
            total_pot += end2end_factor*potential[0]['E2End Harm'].pow(2)
