...
for epoch in range(max_epochs):
    ...
    for data in training_dataset:
        ...
        # Compute Pairwise Distance Matrix of Prediction
        pred_matrix = dist_matrix(output,output)
        # Computer Pairwise Distance Matrix of Target
        y = y[:,:3]
        y_matrix = dist_matrix(y,y)
        # Loss computation
        optimizer.zero_grad()
        loss = F.mse_loss(output, y) + F.mse_loss(pred_matrix,y_matrix)
