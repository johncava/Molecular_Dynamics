...
class YamlForcefield(_ForceFieldBase):
    ...
    def get_dihedral(self, at1, at2, at3, at4):
        ...
        # print(params)
        # JV edit.  There seems to be a bug here.  Iterable params["terms"] returns key not dict.
        terms = []
        for term in params["terms"]:
            # print(term)
            # my hack below            
            terms.append([params["terms"][term]["phi_k"], radians(params["terms"][term]["phase"]), params["terms"][term]["per"]])
