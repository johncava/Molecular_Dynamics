...
class Energy:
    ...
    def calc_energy(self, coords, time=None):
        ...
        print(torch.tensor(coords))
        self.system.set_positions(torch.tensor(coords))
