...
files = glob.glob('./../../All_ML_Training_Data/210905_SMD_decaalanine/SMD/output/raw_backbone_npy_traj/*.npy')
...
for q, learning_rate in enumerate([1e-2, 1e-2,1e-2, 1e-3, 1e-3, 1e-3,1e-3,1e-4]):
    ...
    for epoch in range(max_epochs):
        ...
        for i, data in enumerate(pretrain_dataloader):
            ...
            recon_loss = dis_factor*F.mse_loss(dist_pred, dist_target) + rmsd_loss
